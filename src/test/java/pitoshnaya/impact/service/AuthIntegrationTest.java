...
public class AuthIntegrationTest {
  ...
  void testUserRegistrationAndLogin() {
    ...
    ResponseEntity<AuthResponse> loginResponse =
        restTemplate.postForEntity(
            "/api/login", new AuthRequest(username, password), AuthResponse.class);
  ...
  void testOnlyLatestTokenIsValid() {
    ...
    ResponseEntity<AuthResponse> loginResponse1 =
        restTemplate.postForEntity(
            "/api/login", new AuthRequest(username, password), AuthResponse.class);
    ...
    ResponseEntity<AuthResponse> loginResponse2 =
        restTemplate.postForEntity(
            "/api/login", new AuthRequest(username, password), AuthResponse.class);
    ...
    ResponseEntity<String> oldTokenResponse =
        restTemplate.exchange("/hello", HttpMethod.GET, request1, String.class);
    Assertions.assertEquals(
        HttpStatus.FORBIDDEN,
        oldTokenResponse.getStatusCode(),
    ...
    ResponseEntity<String> newTokenResponse =
        restTemplate.exchange("/hello", HttpMethod.GET, request2, String.class);
    Assertions.assertEquals(
        HttpStatus.OK, newTokenResponse.getStatusCode(), "Второй токен должен быть валидным");
  }
}
